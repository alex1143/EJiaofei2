...
import com.dxkj.ejiaofei.ejiaofei.bean.GesturePoint;
import com.dxkj.ejiaofei.ejiaofei.utils.AppUtils;
...
public class GestureDrawline extends View {
    ...
    private int mov_x;                            //起点坐标
    private int mov_y;
    private Paint paint;                          //画笔
    private Canvas canvas;                        //画布
    private Bitmap bitMap;                        //位图
    private List<GesturePoint> list;              //点坐标的集合
    ...
    public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
        ...
        super(context);
        screenDispaly = AppUtils.getScreenDispaly(context);           //获取屏幕长宽
        paint = new Paint(Paint.DITHER_FLAG);                         //设置画笔
        bitMap = Bitmap.createBitmap(screenDispaly[0], screenDispaly[0], Bitmap.Config.ARGB_8888);  //设置位图
    ...
    public void initAutoCheckPointMap() {
    ...
    public GesturePoint getGesturePointByNum(int num) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        paint.setColor(Color.rgb(245, 142, 33));             //设置线条的颜色
